...
// ExecutePython mocks base method
func (m *MockLocalJob) ExecutePython(pythonFilePath string, envVars []string, log logrus.FieldLogger) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ExecutePython", pythonFilePath, envVars, log)
	ret0, _ := ret[0].(error)
	return ret0
}

// ExecutePython indicates an expected call of ExecutePython
func (mr *MockLocalJobMockRecorder) ExecutePython(pythonFilePath, envVars, log interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ExecutePython", reflect.TypeOf((*MockLocalJob)(nil).ExecutePython), pythonFilePath, envVars, log)
}
