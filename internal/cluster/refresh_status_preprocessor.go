...
func newValidations(log logrus.FieldLogger) []validation {
	...
	ret := []validation{
		...
		{
			id:        isApiVipBelongToMachineCidrAndNotInUse,
			condition: v.isApiVipBelongToMachineCidrAndNotInUse,
			formatter: v.printIsApiVipBelongToMachineCidrAndNotInUse,
		},
		{
			id:        isIngressVipBelongToMachineCidrAndNotInUse,
			condition: v.isIngressVipBelongToMachineCidrAndNotInUse,
			formatter: v.printIsIngressApiVipBelongToMachineCidrAndNotInUse,
		},
		{
