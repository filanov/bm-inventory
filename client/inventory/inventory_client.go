...
type API interface {
	...
	PostStepReply(ctx context.Context, params *PostStepReplyParams) (*PostStepReplyCreated, error)
	/*
...
PostStepReply posts the result of the required operations from the server
*/
func (a *Client) PostStepReply(ctx context.Context, params *PostStepReplyParams) (*PostStepReplyCreated, error) {
	...
	return result.(*PostStepReplyCreated), nil
