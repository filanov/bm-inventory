...
// DownloadClusterKubeconfigParams contains all the bound params for the download cluster kubeconfig operation
...
func (o *DownloadClusterKubeconfigParams) bindClusterID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
...
func (o *DownloadClusterKubeconfigParams) validateClusterID(formats strfmt.Registry) error {
